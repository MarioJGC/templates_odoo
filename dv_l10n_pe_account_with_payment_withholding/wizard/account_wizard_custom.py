...
class RetentionPaymentWizardUltimate(models.TransientModel):
    _name = 'retention.payment.wizard.ultimate'
    _description = 'Wizard para registrar pagos con retención'

    # Campos necesarios por defecto
    ...
    line_ids = fields.Many2many(
        'account.move.line',
        'retention_payment_wizard_move_line_rel',
        'wizard_id',
        'line_id',
    ...
    #Agrupa lineas de asientos contables
    ...
    def _compute_from_lines(self):
        ...
        for wizard in self:
            ...
            if len(batches) == 1:
                ...
                #Selecciona por defecto el cliente de la primera factura
                if wizard.l10n_pe_withholding_subject_invoice_ids:
                    wizard.partner_id = wizard.l10n_pe_withholding_subject_invoice_ids[0].partner_id.id
